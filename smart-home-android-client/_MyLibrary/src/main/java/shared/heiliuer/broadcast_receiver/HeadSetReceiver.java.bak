...
public class HeadSetReceiver extends BroadcastReceiver {
	...
	private static HeadSetReceiver receiver;
	...
	public static boolean register(Context c,
		...
		context = c;
		if (receiver == null)
			receiver = new HeadSetReceiver(onHeadSetStateChange);
	...
	private HeadSetReceiver(OnHeadSetStateChange onHeadSetStateChange) {
