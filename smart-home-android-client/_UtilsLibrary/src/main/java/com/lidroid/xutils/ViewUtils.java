...
import com.lidroid.xutils.view.InjectableContext;
...
public class ViewUtils {
	 ...
	 * @author hao.wang
	 * @param fragment
	 *            必须加入setContentView方法
	 * @param rootView
	 */
	public static void inject(InjectFragment fragment) {
	 ...
	 * @param rootView
	 */
	public static void inject(InjectableContext context) {
		injectObject(context, new ViewFinder(context));
	}
